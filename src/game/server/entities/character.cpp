...
void CCharacter::FireWeapon()
{
	...
	// check for ammo
	if(!m_aWeapons[m_ActiveWeapon].m_Ammo && false)
	{
	...
	switch(m_ActiveWeapon)
	{
		...
		{
			// vec2 exPos;
			// int collision = GameServer()->Collision()->IntersectLine(m_Pos, m_Pos + vec2(cosf(m_Core.m_Angle/256.0f), sinf(m_Core.m_Angle/256.0f))*32*7, 0, &exPos);
